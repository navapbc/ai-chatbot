export const webAutomationPrompt = `
...
**Tool Usage:**
- When calling browserSnapshot, always provide an empty object {} as the parameter
- Use element refs (@e1, @e2, etc.) from snapshots to interact with elements
